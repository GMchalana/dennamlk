  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`w-full fixed ${ShowElement ? `bg-opacity-100 shadow-xl` : `bg-opacity-0 `} bg-[#c3ddef] flex 
      justify-between px-6 sm:px-12 py-2 sm:py-4  transition duration-4000 translate-y-0 z-20`}
      >
        {/* Logo A */}
       <img 
          src="/dennam/logo.png" // Path to your image in public folder
          alt="Logo"
          className="h-20 w-auto object-cover" // Adjust size as needed
        />
